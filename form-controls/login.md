...
*   **Password** <span style="color:red; font-weight:bold; font-size:1.2em;">*</span>: REQUIRED: The password for the user account that will be logged-in. Typically this will be a Field Token that is bound to a `<Password>` form control.
...
*   **Username** <span style="color:red; font-weight:bold; font-size:1.2em;">*</span>: REQUIRED: The username of the account to be logged in. Typically this will be a Field Token bound to a `<TextBox>` form control.
