...
*   **Email** <span style="color:red; font-weight:bold; font-size:1.2em;">*</span>: Required. The user's email address.
...
*   **FirstName** <span style="color:red; font-weight:bold; font-size:1.2em;">*</span>: Required. The user's first name.

*   **LastName** <span style="color:red; font-weight:bold; font-size:1.2em;">*</span>: Required. The user's last name.
...
*   **Username** <span style="color:red; font-weight:bold; font-size:1.2em;">*</span>: Required. A unique name that will be associated with this user account.
