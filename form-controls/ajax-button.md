...
category: Buttons
context: form
summary: The AjaxButton tag renders a push-button that, when clicked, fetches HTML from a URL and inserts it into a target element on the page — without a postback.
keywords:
  - ajax
  - button
  - form
