...
hero:
  name: "XMod Pro"
  text: "Documentation"
  tagline: Build powerful DNN modules without programming
  actions:
    - theme: brand
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/dnndev/xmp-docs

features:
  - icon: 🎨
    title: No Programming Required
    details: Create templates and forms with standard HTML. Display your data your way with simple field tokens like [[FirstName]].
  - icon: 🗄️
    title: Direct Database Control
    details: Connect to your own data using standard SQL commands and stored procedures. You're in complete control.
  - icon: 🛠️
    title: Rich Form Controls
    details: Built-in controls including textbox, dropdown, date input, file upload, and more. Build or buy custom controls for maximum flexibility.
  - icon: 📝
    title: Powerful Templates
    details: Create templates for displaying lists and single records. Add XMod Pro tags for additional functionality like detail buttons and formatting.
---
