...
With XMod Pro, you are in control. You create views and forms made up of standard HTML. You can create views for displaying lists of data and views for displaying a single record. But how does XMod Pro link up with your data? You simply supply standard SQL commands such as SELECT commands and stored procedures. Then, for views, wherever you want to display the value of a given field, use a field "token" like `[[FirstName]]` to display the value in the FirstName field. For forms, you simply assign a field name to a given control to 'bind' it to that field.

Optionally, you can add a few XMod Pro tags to your views that give you additional functionality like detail buttons to show a record's detail view, a format tag to format your numbers, dates, etc. for display and much more. The result is *your* data, displayed *your* way - no programming required.
